              ...
              <form class="space-y-4 md:space-y-6">
                ...
                <div>
                  <input
                    ...
                    name="email"
                    id="email"
                    class="bg-[#22134E] h-[6vh] border border-[#22134E] text-white sm:text-sm rounded-md focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 border-[#22134E] placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                  <input
                    ...
                    class="bg-[#22134E] h-[6vh] border border-[#22134E] text-white sm:text-sm rounded-md focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 placeholder-gray-400 focus:ring-blue-500 focus:border-blue-500"
                    required
