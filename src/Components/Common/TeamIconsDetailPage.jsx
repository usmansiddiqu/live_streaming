...
function TeamIconsDetailPage({ iconsData }) {
  ...
  return (
    ...
    >
      <span className="py-auto text-white font-medium">123 </span>
    </div>
    </>
      }
      {isTabletOrMobile && <>
      ...
      >
       ...
       <div
        className="w-[278px] team-namess h-[0] bg-gradient-to-r from-[#00C4FF] to-[#0074FF] absolute rounded-b-xl text-center flex justify-center items-center py-1 "
        style={{
          right: "0%",
        }}
      >
        <span className="py-auto text-white font-medium">okok </span>
      </div></>}
