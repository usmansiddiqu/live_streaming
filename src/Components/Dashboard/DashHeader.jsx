...
function DashHeader({ title, subtitle }) {
  return (
    <div
      className=" text-[white]  h-[20vh] relative dash-header md:w-100 object-cover bg-center bg-opacity-90 flex flex-row flex-wrap items-center justify-around lg:justify-between"
      style={{
