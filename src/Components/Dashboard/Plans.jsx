...
function Plans() {
  return (
    <div className="px-40 bg-[#0D0620] py-5">
      <div className="flex flex-row justify-around text-white bg-[#130A2D] py-10 rounded  gap-5 px-5">
        ...
        <div
          className="flex flex-col gap-8 justify-start items-start ps-7 pt-4 w-[34rem] h-56 bg-center rounded-xl"
          style={{
        ...
        <div
          className="flex flex-col gap-3 justify-start items-start ps-7 pt-4 w-[34rem] h-56 bg-center rounded-xl"
          style={{
            backgroundColor: "#1F1340",
            backgroundImage: `url(${plan})`,
          }}
